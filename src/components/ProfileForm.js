  ...
  const handleSubmit = (e) => {
    e.preventDefault()
      if (password === originalPassword){
        sendUpdateProfile([{ profile_img_url: profileImgUrl, first_name: firstName, last_name: lastName}, user_id])
              ...
              <Row>
                <Col>
                  <Form.Group controlId="formFirstName" className="mx-sm-3 mb-2">
                    <Form.Label className="profile-input">First Name</Form.Label>
                ...
                <Col>
                  <Form.Group controlId="formLastName" className="mx-sm-3 mb-2">
                    <Form.Label className="profile-input">Last Name</Form.Label>
                ...
                <Row>
                    ...
                    <Form.Group controlId="formProfileImgUrl" className="mx-sm-3 mb-2">
                        <Form.Label className="profile-input">Profile Image URL</Form.Label>
                  ...
                  <Form.Group controlId="formPassword" className="mx-sm-5 mb-2">
                      <Form.Label className="profile-input">Password</Form.Label>
